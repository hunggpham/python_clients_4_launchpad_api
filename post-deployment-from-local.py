...
#    'id' : '1c145f51-b33d-44c6-90aa-869493e28bd9',
  ...
  'config' : {
    ...
    print 'Doing POST request to http://54.164.165.51:8080/api/environments with:\n'
    pprint(deployment)

    headers = {'content-type': 'application/json'}
    result = requests.post('http://localhost:8080/api/v1/environments/'+envname+'/deployments', data=json.dumps(deployment), headers=headers)
